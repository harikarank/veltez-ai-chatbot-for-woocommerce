	...
	<form action="options.php" method="post" id="aiwoo-settings-form">
		...
		<div id="aiwoo-tab-general" class="aiwoo-tab-pane">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-enabled"><?php esc_html_e( 'Enable widget', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'enabled' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-max_message_length"><?php esc_html_e( 'Max message length', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'max_message_length' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-provider"><?php esc_html_e( 'AI provider', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'provider' ) ); ?></td>
				</tr>
				<?php /* ── OpenAI fields ── */ ?>
				<tr data-aiwoo-provider="openai">
					<th scope="row"><label for="ai-woo-assistant-openai_api_key"><?php esc_html_e( 'OpenAI API key', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'openai_api_key' ) ); ?></td>
				</tr>
				<tr data-aiwoo-provider="openai">
					<th scope="row"><label for="ai-woo-assistant-openai_model"><?php esc_html_e( 'OpenAI model', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'openai_model' ) ); ?></td>
				</tr>
				<?php /* ── Claude fields ── */ ?>
				<tr data-aiwoo-provider="claude">
					<th scope="row"><label for="ai-woo-assistant-claude_api_key"><?php esc_html_e( 'Anthropic API key', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'claude_api_key' ) ); ?></td>
				</tr>
				<tr data-aiwoo-provider="claude">
					<th scope="row"><label for="ai-woo-assistant-claude_model"><?php esc_html_e( 'Claude model', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'claude_model' ) ); ?></td>
				</tr>
				<?php /* ── Gemini fields ── */ ?>
				<tr data-aiwoo-provider="gemini">
					<th scope="row"><label for="ai-woo-assistant-gemini_api_key"><?php esc_html_e( 'Google AI Studio API key', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'gemini_api_key' ) ); ?></td>
				</tr>
				<tr data-aiwoo-provider="gemini">
					<th scope="row"><label for="ai-woo-assistant-gemini_model"><?php esc_html_e( 'Gemini model', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'gemini_model' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-temperature"><?php esc_html_e( 'Response temperature', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'temperature' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-max_context_products"><?php esc_html_e( 'Catalog products in context', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
		...
		<div id="aiwoo-tab-widget" class="aiwoo-tab-pane" hidden>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-panel_title"><?php esc_html_e( 'Panel header title', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'panel_title' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-panel_subtitle"><?php esc_html_e( 'Panel header subtitle', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'panel_subtitle' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-chat_placeholder"><?php esc_html_e( 'Chat input placeholder', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'chat_placeholder' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-company_logo"><?php esc_html_e( 'Panel header logo', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'company_logo' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-employee_photo"><?php esc_html_e( 'Assistant avatar photo', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'employee_photo' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-chat_icon"><?php esc_html_e( 'Chat launcher icon', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'chat_icon' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-welcome_message"><?php esc_html_e( 'Welcome message', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'welcome_message' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-auto_open_delay"><?php esc_html_e( 'Auto-open delay', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'auto_open_delay' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-enquiry_title"><?php esc_html_e( 'Enquiry form title', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'enquiry_title' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-enquiry_content"><?php esc_html_e( 'Enquiry form intro text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'enquiry_content' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-no_match_text"><?php esc_html_e( 'No-match fallback text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
		...
		<div id="aiwoo-tab-appearance" class="aiwoo-tab-pane" hidden>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-primary_color"><?php esc_html_e( 'Accent color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'primary_color' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_primary_hover"><?php esc_html_e( 'Accent hover color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_surface"><?php esc_html_e( 'Widget background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_surface' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_bg"><?php esc_html_e( 'Messages area background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_border"><?php esc_html_e( 'Border color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_border' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_text"><?php esc_html_e( 'Body text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_text' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_text_soft"><?php esc_html_e( 'Secondary text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-border_radius"><?php esc_html_e( 'Corner radius (px)', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_panel_border"><?php esc_html_e( 'Panel border color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_panel_border' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_header_border_bottom"><?php esc_html_e( 'Header bottom border color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_header_bg"><?php esc_html_e( 'Header background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_header_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_header_text"><?php esc_html_e( 'Header text &amp; icons', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_user_bubble_bg"><?php esc_html_e( 'User message background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_user_bubble_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_user_bubble_text"><?php esc_html_e( 'User message text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_user_bubble_text' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_agent_bubble_bg"><?php esc_html_e( 'Agent message background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_agent_bubble_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_agent_bubble_text"><?php esc_html_e( 'Agent message text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_form_bg"><?php esc_html_e( 'Form area background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_form_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_form_border"><?php esc_html_e( 'Form top border color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_form_border' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_input_bg"><?php esc_html_e( 'Input background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_input_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_input_text"><?php esc_html_e( 'Input text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_input_text' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_send_bg"><?php esc_html_e( 'Send button background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_send_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_send_text"><?php esc_html_e( 'Send button text', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_send_text' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_send_hover_bg"><?php esc_html_e( 'Send button hover background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_loading_bg"><?php esc_html_e( 'Typing indicator background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_loading_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_loading_text"><?php esc_html_e( 'Typing indicator text color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_loading_text' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_counter_bg"><?php esc_html_e( 'Character counter background', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
					<td><?php $settings->render_field( array( 'key' => 'color_counter_bg' ) ); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="ai-woo-assistant-color_counter_text"><?php esc_html_e( 'Character counter text color', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
		...
		<div id="aiwoo-tab-prompt" class="aiwoo-tab-pane" hidden>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="ai-woo-assistant-system_prompt"><?php esc_html_e( 'Additional system prompt', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label></th>
		...
		<div id="aiwoo-tab-intelligence" class="aiwoo-tab-pane" hidden>
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row">
						<label for="ai-woo-assistant-enable_mcp"><?php esc_html_e( 'Enable MCP tool calling', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label>
					</th>
					<td>
						<label>
							<input
				...
				<tr>
					<th scope="row">
						<label for="ai-woo-assistant-mcp_max_products"><?php esc_html_e( 'Max products per tool call', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label>
					</th>
					<td>
						<input
							type="number"
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row">
						<label for="ai-woo-assistant-enable_personalization"><?php esc_html_e( 'Enable personalisation', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label>
					</th>
					<td>
						<label>
							<input
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row">
						<label for="ai-woo-assistant-enable_upsell"><?php esc_html_e( 'Enable upsell / cross-sell', 'veltez-ai-chatbot-product-recommendations-for-woocommerce' ); ?></label>
					</th>
					<td>
						<label>
							<input
