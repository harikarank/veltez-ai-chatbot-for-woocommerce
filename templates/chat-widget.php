...
<div class="aiwoo-widget" data-aiwoo-widget>
	...
	>
		<img
			...
			src="<?php echo ! empty( $icon_url ) ? esc_url( $icon_url ) : esc_url( VELTEZ_AI_URL . 'assets/img/favicon-white.svg' ); ?>"
			alt=""
		/>
	</button>
		...
		<header class="aiwoo-panel__header">
			<div class="aiwoo-panel__header-info">
				<img
					...
					src="<?php echo ! empty( $company_logo ) ? esc_url( $company_logo ) : esc_url( VELTEZ_AI_URL . 'assets/img/favicon-white.svg' ); ?>"
